...
def main():
    if os.path.exists('C://SCRIPTS//SCRIPTS//Python Scripts//Learning Home Work//ACI Inventory//ACI_Node_Output21.csv'):
        os.remove('C://SCRIPTS//SCRIPTS//Python Scripts//Learning Home Work//ACI Inventory//ACI_Node_Output21.csv')

    w = open('C://SCRIPTS//SCRIPTS//Python Scripts//Learning Home Work//ACI Inventory//ACI_Node_Output21.csv', 'w')
    w.writelines('APIC,Pod,Node,Port,Adminstate,Native_vlan,Encap-VLAN' + '\n')
    w.close()
    if os.path.exists(
            'C://SCRIPTS//SCRIPTS//Python Scripts//Learning Home Work//ACI Inventory//ACI_Node_Output_Nodes_Missing.csv'):
        os.remove(
            'C://SCRIPTS//SCRIPTS//Python Scripts//Learning Home Work//ACI Inventory//ACI_Node_Output_Nodes_Missing.csv')

    w = open(
        'C://SCRIPTS//SCRIPTS//Python Scripts//Learning Home Work//ACI Inventory//ACI_Node_Output_Nodes_Missing.csv','w')
        ...
        for Pod in range(1, 2):
            ...
            for NodeNum in range(11, 13):
                ...
                for item in final_intf_data:
                    ...
                    adminstate = str(item['adminSt'])
                    pods = str(Pod)
                    z = (aci + ',' + ACI_node + ',' + pods + ',' + port + ',' + adminstate + ',' + native_vlan + ',' + encap_vlan + '\n')
                    with open(
                            'C://SCRIPTS//SCRIPTS//Python Scripts//Learning Home Work//ACI Inventory//ACI_Node_Output21.csv',
                            'a') as csv_file:
                        csv_file.write(z)
