...
########### New Funaction add 26/04/2023

def createMissingXLSX():
    from openpyxl import Workbook, load_workbook
    if os.path.exists(
            'C:/SCRIPTS/SCRIPTS/Python Scripts/Learning Home Work/ACI Inventory/ACI_Node_Output_Nodes_Missingopenpyxl_Test22.xlsx'):
        os.remove(
            'C:/SCRIPTS/SCRIPTS/Python Scripts/Learning Home Work/ACI Inventory/ACI_Node_Output_Nodes_Missingopenpyxl_Test22.xlsx')
    workbook = Workbook()
    ######sheet is create always change the title ####
    ws1 = workbook.active
    ws1.title = 'One'
    ######Create  new sheet
    ...
    ws1['A1'] = 'APIC'
    ws1['B1'] = 'Pod'
    ws1['C1'] = 'ACI_Node_Not_Available'
    ws2['A1'] = 'Copy of APIC'
    workbook.save(filename="C:/SCRIPTS/SCRIPTS/Python Scripts/Learning Home Work/ACI Inventory/ACI_Node_Output_Nodes_Missingopenpyxl_Test22.xlsx")
