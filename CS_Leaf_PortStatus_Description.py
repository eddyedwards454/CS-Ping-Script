    ...
    for aci in aci_devices:
        ...
        for Pod in range(1, 2):
            ...
            for NodeNum in range(11, 13 ):
                ...
                # url4 = f'https://{aci}/api/node/mo/uni/infra.json?query-target=subtree&target-subtree-class=infraAccPortP&rsp-subtree=full&rsp-subtree-class=infraHPortS,infraPortBlk,infraSubPortBlk'
                url4 = f'https://{aci}/api/node/mo/uni/infra.json?query-target=subtree&target-subtree-class=infraAccPortP'
                ...
                aci_get4 = requests.get(url=url4, cookies=aci_cookie, verify=False)
                initial_intf_data1 = aci_get.json()["imdata"]
                initial_intf_data2 = aci_get2.json()["imdata"]
                initial_vlan_data = aci_get3.json()["imdata"]
                initial_vlan_data4 = aci_get4.json()["imdata"]
                print(initial_vlan_data4)
